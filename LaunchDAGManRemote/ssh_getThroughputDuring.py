...
#
#
# This files SSH's into OSG and runs the script there to get the throughput of
# a DAGMan FakeQuakes run. It then retrieves a txt file with the throughput and brings
...
def main(arg1):
    ...
    cmmd = "sh getThroughputDuring_v2_4_to_txt.sh " + dirname
