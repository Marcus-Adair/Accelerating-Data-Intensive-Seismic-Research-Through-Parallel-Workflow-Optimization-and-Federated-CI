...
#
#
# This files SSH's into OSG and runs the script there to get time statistics after
# a DAGMan FakeQuakes run is complete. It then retrieves a txt file with the time stats and brings
# it back to the current directory.
#
# To run this just import ssh_getStatsPost and call ssh_getStatsPost.main()
# with the name of a directory that you want to check in main()
#
#   Or use the command line (in an environment with paramiko) and send in the dirname you want to get stats from: 'python ssh_getStatsPost dirname'
...
def main(arg1):
    ...
    cmmd = "sh getStatsPost_v2_4_to_txt.sh " + dirname
